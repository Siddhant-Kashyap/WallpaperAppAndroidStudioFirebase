...
public class FullImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageView =  findViewById(R.id.FullImageActivity);
        SetButton = findViewById(R.id.AbstractSet);
        ...
        Glide.with(this).load(getIntent().getStringExtra("abstract")).into(mImageView);
