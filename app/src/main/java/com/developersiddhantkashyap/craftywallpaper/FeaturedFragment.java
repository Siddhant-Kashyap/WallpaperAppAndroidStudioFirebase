...
public class FeaturedFragment extends Fragment {
    ...
    private FeaturedWallpaperAdapter fWallpaperAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
       ...
       recyclerview =view.findViewById(R.id.FeaturedFragmentView);


       databaseReference= FirebaseDatabase.getInstance().getReference().child("featured");
    ...
    private void getData() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                fWallpaperAdapter=new FeaturedWallpaperAdapter(list,getContext());

                recyclerview.setAdapter(fWallpaperAdapter);
